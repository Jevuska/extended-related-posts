 ...
 * :: abuse wp_upload_dir to new function jv_upload_dir for default image thumbnail
 * by @jevuska
	...
	class Aq_Resize
	{
		...
		public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false )
		{
			...
			try {
				...
				if ( true === $upscale )
					add_filter( 'image_resize_dimensions', array(
						 $this,
						'aq_upscale' 
					), 10, 6 );
				...
				// Okay, leave the ship.
				if ( true === $upscale )
					remove_filter( 'image_resize_dimensions', array(
						$this,
						'aq_upscale' 
					) );
		...
		function jv_upload_dir()
		{
			$args = array(
				'basedir' => EXTRP_PATH_PLUGIN_IMAGES,
				'baseurl' => EXTRP_URL_PLUGIN_IMAGES 
			);
			return $args;
		}
...
if ( !function_exists( 'extrp_aq_resize' ) ) {
	 ...
	 */
	function extrp_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false )
	{
